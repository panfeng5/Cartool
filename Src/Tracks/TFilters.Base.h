...
namespace crtl
{
    ...
    TFilter<TypeD> *TFilters<TypeD>::Clone(const TFilter<TypeD> *filter) const
    {
        ...
        if (typeid(*filter) == typeid(TFilterBaseline<TypeD>))
            return new TFilterBaseline<TypeD>(*dynamic_cast<const TFilterBaseline<TypeD> *>(filter));
        else if (typeid(*filter) == typeid(TFilterButterworthBandPass<TypeD>))
            return new TFilterButterworthBandPass<TypeD>(*dynamic_cast<const TFilterButterworthBandPass<TypeD> *>(filter));
        else if (typeid(*filter) == typeid(TFilterButterworthBandStop<TypeD>))
            return new TFilterButterworthBandStop<TypeD>(*dynamic_cast<const TFilterButterworthBandStop<TypeD> *>(filter));
        else if (typeid(*filter) == typeid(TFilterButterworthHighPass<TypeD>))
            return new TFilterButterworthHighPass<TypeD>(*dynamic_cast<const TFilterButterworthHighPass<TypeD> *>(filter));
        else if (typeid(*filter) == typeid(TFilterButterworthLowPass<TypeD>))
            return new TFilterButterworthLowPass<TypeD>(*dynamic_cast<const TFilterButterworthLowPass<TypeD> *>(filter));
        else if (typeid(*filter) == typeid(TFilterEnvelope<TypeD>))
            return new TFilterEnvelope<TypeD>(*dynamic_cast<const TFilterEnvelope<TypeD> *>(filter));
        else if (typeid(*filter) == typeid(TFilterRanking<TypeD>))
            return new TFilterRanking<TypeD>(*dynamic_cast<const TFilterRanking<TypeD> *>(filter));
        else if (typeid(*filter) == typeid(TFilterRectification<TypeD>))
            return new TFilterRectification<TypeD>(*dynamic_cast<const TFilterRectification<TypeD> *>(filter));
        else if (typeid(*filter) == typeid(TFilterReference<TypeD>))
            return new TFilterReference<TypeD>(*dynamic_cast<const TFilterReference<TypeD> *>(filter));
        else if (typeid(*filter) == typeid(TFilterSpatial<TypeD>))
            return new TFilterSpatial<TypeD>(*dynamic_cast<const TFilterSpatial<TypeD> *>(filter));
        else if (typeid(*filter) == typeid(TFilterThreshold<TypeD>))
            return new TFilterThreshold<TypeD>(*dynamic_cast<const TFilterThreshold<TypeD> *>(filter));
        else
