...
#define BadEpochsMetaCritAllName "MC"
    ...
    inline double GetAlphaCut(int numcrit, double alpha) { return BadEpochsCriterionCalib[numcrit - 1][Center] + alpha * (alpha < 0 ? BadEpochsCriterionCalib[numcrit - 1][SpreadLeft]
