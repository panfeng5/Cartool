...
#define WeightedBrainCond (0.57 * TissuesSpecs[GreyIndex].Conductivity + 0.37 * TissuesSpecs[WhiteIndex].Conductivity + 0.05 * TissuesSpecs[CsfIndex].Conductivity + 0.01 * TissuesSpecs[BloodIndex].Conductivity)
    // That should be the conductivity for Ary, which groups scalp+brain vs skull -> 0.3881
#define WeightedBrainScalpCond (0.5 * WeightedBrainCond + 0.5 * TissuesSpecs[ScalpIndex].Conductivity)
