...
namespace crtl
{
    ...
    public:
        ...
        TGLColor(GLfloat r, GLfloat g, GLfloat b, GLfloat a)
        {
            Red = (TypeD)r;
            Green = (TypeD)g;
            Blue = (TypeD)b;
        ...
        TGLColor(GLdouble r, GLdouble g, GLdouble b, GLdouble a)
        {
            Red = (TypeD)r;
            Green = (TypeD)g;
            Blue = (TypeD)b;
        ...
        void Set(GLdouble r, GLdouble g, GLdouble b, GLdouble a)
        {
            Red = r;
            Green = g;
            Blue = b;
...
#define GLColorNearlyWhite 0.98, 0.98, 0.98
    ...
    // Alpha behavior
    enum
    {                              // any >= 0 value -> take value as alpha
    ...
    public:
        ...
        void GLize(int param)
        {
            GetColor(param, ColorReturned);
            ColorReturned.GLize();
        }
