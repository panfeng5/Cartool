...
namespace crtl
{
    ...
    public:
        ...
        TGLCoordinates(TypeD x, TypeD y, TypeD z)
        {
            X = x;
            Y = y;
            Z = z;
        ...
        TGLCoordinates(TypeD x, TypeD y, TypeD z, TypeD w)
        {
            X = x;
            Y = y;
            Z = z;
        ...
        void Set(TypeD x, TypeD y, TypeD z, TypeD w)
        {
            X = x;
            Y = y;
            Z = z;
        ...
        TGLCoordinates<TypeD> operator*=(const double op2[])
        {
            X *= op2[0];
            Y *= op2[1];
            Z *= op2[2];
        ...
        TGLCoordinates<TypeD> operator*=(double op2)
        {
            X *= op2;
            Y *= op2;
            Z *= op2;
        ...
        TGLCoordinates<TypeD> operator+=(const TPointDouble &op2)
        {
            X += op2.X;
            Y += op2.Y;
            Z += op2.Z;
        ...
        TGLCoordinates<TypeD> operator+=(const TPointFloat &op2)
        {
            X += op2.X;
            Y += op2.Y;
            Z += op2.Z;
