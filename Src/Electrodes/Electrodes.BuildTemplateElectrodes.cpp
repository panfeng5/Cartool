...
namespace crtl
{
    ...
    OptimizeOff
        ...
        void
        BuildTemplateElectrodes(const TGoF &filesin,
                                ...
                                const char *filesout)
    {
        if (filesin.IsEmpty() || StringIsEmpty(filesout) || czindex.IsNotAllocated() || fpzindex.IsNotAllocated() || ozindex.IsNotAllocated())
