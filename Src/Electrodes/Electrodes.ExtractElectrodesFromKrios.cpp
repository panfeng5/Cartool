...
namespace crtl
{
    ...
    OptimizeOff
        ...
        bool
        ExtractElectrodesFromKrios(const char *filein,
                                   ...
                                   char *fileout)
    {
        ...
        if (StringContains((const char *)krioscsv.GetAttribute(KriosX), "(cm)"))
            scaling = 10;
        else if (StringContains((const char *)krioscsv.GetAttribute(KriosX), "(mm)"))
            scaling = 1;
        else
            scaling = 1;
