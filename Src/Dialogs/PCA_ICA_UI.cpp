    ...
    void TCartoolMdiClient::PCA_ICA_UI(owlwparam w)
    {
        ...
        if (!filenames.AnyTracksGroup(tg))
        {
            ...
            if (tg.noneofthese)
                ...
                ShowMessage("Files don't seem to be consistently of the EEG type!", pcatitle, ShowMessageWarning);
            else if (!tg.allris)
                ShowMessage("Files don't seem to be consistently of the RIS type!", pcatitle, ShowMessageWarning);
            else
                ShowMessage("Files don't seem to be consistently of the same type!", pcatitle, ShowMessageWarning);
