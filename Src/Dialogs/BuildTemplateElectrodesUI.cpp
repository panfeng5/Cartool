...
#define AveragingXyzTitle "Averaging Electrodes Coordinates"
        ...
        void
        TCartoolMdiClient::BuildTemplateElectrodesUI()
    {
        // show some intro
        ...
        if (!GetInputFromUser("Which electrodes are Cz / Vertex (provide multiple names to get an average):", "Cz / Vertex", inputcz, ""))
            return;
        if (!GetInputFromUser("Which electrodes are Fpz / Front (provide multiple names to get an average):", "Fpz / Front", inputfpz, ""))
            return;
        if (!GetInputFromUser("Which electrodes are Oz / Back (provide multiple names to get an average):", "Oz / Back", inputoz, ""))
            return;
