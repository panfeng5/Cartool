...
namespace crtl
{
    ...
    {
        return IsInsideLimits(preset, (int)FreqPresetSurfacePowermaps, (int)FreqPresetSurfaceFftapproxSt) || IsInsideLimits(preset, (int)FreqPresetIntraFft, (int)FreqPresetIntraFftSt) || IsInsideLimits(preset, (int)FreqPresetFft, (int)FreqPresetFftSt);
    }
    ...
    {
        return IsInsideLimits(preset, (int)FreqPresetIntraFft, (int)FreqPresetIntraFftSt) || IsInsideLimits(preset, (int)FreqPresetFft, (int)FreqPresetFftSt);
    }

    // Only Short-Term FFT
    inline bool IsStFFT(int preset)
    {
        return preset == FreqPresetSurfacePowermapsSt || preset == FreqPresetSurfaceFftapproxSt || preset == FreqPresetIntraFftSt || preset == FreqPresetFftSt;
    }

    // Only S-Transform
    inline bool IsSTransform(int preset)
    {
        return preset == FreqPresetSurfaceStransf || preset == FreqPresetSurfaceStransfForESI || preset == FreqPresetIntraStransf || preset == FreqPresetIntraStransfPhase || preset == FreqPresetStransf;
    }
