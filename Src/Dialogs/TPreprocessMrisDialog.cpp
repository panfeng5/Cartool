...
namespace crtl
{
    ...
    {
        delete Presets;
        delete PresetsMriType;
        delete FullHeadCleanUp;
        delete Isotropic;
        delete Resizing;
        delete ResizingVoxel;
        delete ResizingRatio;
        delete ResizingVoxelValue;
        delete ResizingRatioValue;
        delete Reorienting;
        delete ReorientingRas;
        delete ReorientingOther;
        delete ReorientingX;
        delete ReorientingY;
        delete ReorientingZ;
        delete AlignSagittal;
        delete AlignTransverse;
        delete SettingOrigin;
        delete SettingOriginIfNotSet;
        delete SettingOriginAlways;
        delete OriginMni;
        delete OriginCenter;
        delete OriginFixed;
        delete OriginX;
    ...
    {
        tce.Enable(PresetsSkullStripping->GetSelIndex() != MriSkullStrippingPresetOff && PresetsGrey->GetSelIndex() != GreyMaskPresetOff);
    }

    void TPreprocessMrisDialog::CmSPButtonEnable(TCommandEnabler &tce)
    {
        tce.Enable(PresetsSkullStripping->GetSelIndex() != MriSkullStrippingPresetOff && PresetsGrey->GetSelIndex() != GreyMaskPresetOff && PresetsSP->GetSelIndex() == SPPresetCompute);
    }

    void TPreprocessMrisDialog::CmSPComputeNumEnable(TCommandEnabler &tce)
    {
        tce.Enable(PresetsSkullStripping->GetSelIndex() != MriSkullStrippingPresetOff && PresetsGrey->GetSelIndex() != GreyMaskPresetOff && PresetsSP->GetSelIndex() == SPPresetCompute && CheckToBool(SPNumber->GetCheck()));
    }

    void TPreprocessMrisDialog::CmSPComputeRezEnable(TCommandEnabler &tce)
    {
        tce.Enable(PresetsSkullStripping->GetSelIndex() != MriSkullStrippingPresetOff && PresetsGrey->GetSelIndex() != GreyMaskPresetOff && PresetsSP->GetSelIndex() == SPPresetCompute && CheckToBool(SPResolution->GetCheck()));
    }

    void TPreprocessMrisDialog::CmSPPortEnable(TCommandEnabler &tce)
    {
        tce.Enable(PresetsSkullStripping->GetSelIndex() != MriSkullStrippingPresetOff && PresetsGrey->GetSelIndex() != GreyMaskPresetOff && PresetsSP->GetSelIndex() == SPPresetPorting && CheckToBool(SPResolution->GetCheck()));
    }
    ...
    bool TPreprocessMrisDialog::CmProcessEnable()
    {
        ...
        if (CheckToBool(MriPreprocTransfer.Reorienting) && CheckToBool(MriPreprocTransfer.ReorientingOther))
        {
            ...
            if (!(*tox && *toy && *toz && *tox != *toy && *tox != *toz && *toy != *toz))
                return false;
        ...
        if (CheckToBool(MriPreprocTransfer.SettingOrigin) && CheckToBool(MriPreprocTransfer.OriginFixed) && (StringIsEmpty(MriPreprocTransfer.OriginX) || StringIsEmpty(MriPreprocTransfer.OriginY) || StringIsEmpty(MriPreprocTransfer.OriginZ)))

            return false;

        if (MriPreprocTransfer.PresetsSkullStripping.GetSelIndex() != MriSkullStrippingPresetOff && MriPreprocTransfer.PresetsGrey.GetSelIndex() != GreyMaskPresetOff && MriPreprocTransfer.PresetsSP.GetSelIndex() == SPPresetPorting && (StringIsEmpty(MriPreprocTransfer.SPFromBrain) || StringIsEmpty(MriPreprocTransfer.SPFromSP)))
    ...
    void TPreprocessMrisDialog::CmAlignTransverse()
    {
        ...
        if (CheckToBool(Reorienting->GetCheck()) && CheckToBool(AlignSagittal->GetCheck()) && CheckToBool(AlignTransverse->GetCheck()))
        {
        ...
        if (CheckToBool(Reorienting->GetCheck()) && CheckToBool(AlignSagittal->GetCheck()) && !CheckToBool(SizeOptimal->GetCheck()))
        {
        ...
        else if (!CheckToBool(Reorienting->GetCheck()) || !CheckToBool(AlignSagittal->GetCheck()) && CheckToBool(SizeOptimal->GetCheck()))
        {
    ...
    void TPreprocessMrisDialog::CmOriginMni()
    {
        ...
        if (CheckToBool(SettingOrigin->GetCheck()) && CheckToBool(OriginMni->GetCheck()))
        {
    ...
    void TPreprocessMrisDialog::EvPresetsChange()
    {
        ...
        if (CheckToBool(Reorienting->GetCheck()) && CheckToBool(AlignSagittal->GetCheck()))
        {
        ...
        else if (CheckToBool(SizeOptimal->GetCheck()))
        { // && ! Sagittal
            SizeTransformed->SetCheck(BoolToCheck(true));
            SizeOptimal->SetCheck(BoolToCheck(false));
            SizeUser->SetCheck(BoolToCheck(false));
    ...
    void TPreprocessMrisDialog::EvDropFiles(TDropInfo drop)
    {
        ...
        if ((int)mrifiles == 1 && (int)spfiles == 0 && IsInsideLimits(where.Y, 700, 930))
        {
        ...
        if ((int)mrifiles == 0 && (int)spfiles == 1 && IsInsideLimits(where.Y, 700, 930))
        {
    ...
    void TPreprocessMrisDialog::ProcessCurrent(void *usetransfer, const char * /*moreinfix*/)
    {
        ...
        if (IsOriginSetAlways(origin) || IsOriginSetNoDefault(origin))
        ...
        bool openauto = CheckToBool(transfer->OpenAuto) && (!BatchProcessing || (int)BatchFileNames <= 5);
