...
namespace crtl
{
    ...
    OptimizeOff
        ...
        void
        TCartoolMdiClient::ComputingTemplateMriUI()
    {
        char answer = GetOptionFromUser("Template geometrical reference:" NewLine
                                            NewLine Tab "- (M)NI brain template" NewLine Tab "- (S)elf-referenced template",
        ...
        /*char*/ answer = GetOptionFromUser("Method for computing the Solution Points:" NewLine
                                                NewLine Tab "- (L)oading some existing Solution Points file" NewLine Tab "- (E)xtracting Solution Points from new Template" NewLine Tab "- (N)o Solution Points needed, thanks",
