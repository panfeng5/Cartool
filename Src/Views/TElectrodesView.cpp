    ...
    void TElectrodesView::GLPaint(int how, int renderingmode, TGLClipPlane *otherclipplane)
    {
        ...
        if (CurrentDisplaySpace != DisplaySpace3D)
        {
            if (renderingmode == XyzSolidSmooth)
                renderingmode = XyzSolidFacet;
            else if (renderingmode == XyzTransparentSmooth)
                renderingmode = XyzTransparentFacet;
        }
        ...
        if (renderingmode == XyzLines && (how & GLPaintOpaque) || renderingmode == XyzSolidFacet && (how & GLPaintOpaque) || renderingmode == XyzSolidSmooth && (how & GLPaintOpaque))
        {
            ...
            for (int n = 0; n < ndraws; n++)
            {
                ...
                if (ncutplanes)
                {
                    ...
                    if (n == 0)
                        clipplane[drawi[0]].GLize(CurrentClipPlane);
                    else if (n == 1)
                        clipplane[drawi[0]].GLize(InvertedClipPlane);

                    if (n == 1)
                        clipplane[drawi[1]].GLize(CurrentClipPlane);
                    else if (n == 2)
                        clipplane[drawi[1]].GLize(InvertedClipPlane);

                    if (n == 2)
                        clipplane[drawi[2]].GLize(CurrentClipPlane);
                }
        ...
        if (ShowElectrodes && (how & GLPaintOpaque))
        {
            ...
            for (int e = 0; e < XYZDoc->GetNumElectrodes(); e++)
            {
                ...
                if (CurrentDisplaySpace == DisplaySpace3D && ncutplanes && !(clipplane[0].IsForward() && x < cx + mind || clipplane[0].IsBackward() && x > cx - mind || clipplane[1].IsForward() && y < cy + mind || clipplane[1].IsBackward() && y > cy - mind || clipplane[2].IsForward() && z < cz + mind || clipplane[2].IsBackward() && z > cz - mind))
        ...
        if (CurrentDisplaySpace == DisplaySpace3D && (how & GLPaintOwner) && (how & GLPaintOpaque) && ncutplanes)
        {
        ...
        //- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        // draw the triangulation
        if (renderingmode == XyzTransparentFacet && (how & GLPaintTransparent) || renderingmode == XyzTransparentSmooth && (how & GLPaintTransparent))
        {
        ...
        //- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        // equator circle & axis
        if (CurrentDisplaySpace != DisplaySpace3D && XYZDoc->IsHead() && ShowAxis && (how & GLPaintOpaque) && (how & GLPaintOwner))
        {
