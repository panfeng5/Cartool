...
namespace crtl
{
    ...
    void SetProcessPriority(ProcessPriorityFlags how)
    {
        switch (how)
        {
        case ProcessPriority0:
            SetPriorityClass(GetCurrentProcess(), IDLE_PRIORITY_CLASS);
            break;
        case ProcessPriority1:
            SetPriorityClass(GetCurrentProcess(), BELOW_NORMAL_PRIORITY_CLASS);
            break;
        case ProcessPriority2:
            SetPriorityClass(GetCurrentProcess(), NORMAL_PRIORITY_CLASS);
            break;
        case ProcessPriority3:
            SetPriorityClass(GetCurrentProcess(), ABOVE_NORMAL_PRIORITY_CLASS);
            break;
        case ProcessPriority4:
            SetPriorityClass(GetCurrentProcess(), HIGH_PRIORITY_CLASS);
            break;
        case ProcessPriority5:
...
#define TRegKeyReadWrite(HIVE, KEYNAME) owl::TRegKey(HIVE, KEYNAME, KEY_ALL_ACCESS, owl::TRegKey::CreateOK)
                 ...
                 const char *keyname)
    {
        ...
        { /*DBGM ( ex.what(), "NukeKey exception error"   );*/
            return false;
        }
        catch (...)
        { /*DBGM ( "Error",   "NukeKey error"             );*/
            return false;
        }
    }
                     ...
                     const char *data)
    {
        ...
        { /*DBGM ( ex.what(), "SetDefValue exception error"   );*/
            return false;
        }
        catch (...)
        { /*DBGM ( "Error",   "SetDefValue error"             );*/
            return false;
        }
    }
                  ...
                  const char *data)
    {
        ...
        { /*DBGM ( ex.what(), "SetValue exception error"   );*/
            return false;
        }
        catch (...)
        { /*DBGM ( "Error",   "SetValue error"             );*/
            return false;
        }
    }
                     ...
                     const char *varname)
    {
        ...
        { /*DBGM ( ex.what(), "DeleteValue exception error"   );*/
            return false;
        }
        catch (...)
        { /*DBGM ( "Error",   "DeleteValue error"             );*/
            return false;
        }
    }
    ...
    {
        if (Buff)
            sprintf(StringEnd(Buff), "%c%c", 0x0d, 0x0a);
    }
