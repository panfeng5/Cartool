...
#define DBGM2(S1, S2, B)                 \
    {                                    \
        ShowValues(B, "ss", (S1), (S2)); \
    }
#define DBGM3(S1, S2, S3, B)                    \
    {                                           \
        ShowValues(B, "sss", (S1), (S2), (S3)); \
    }
#define DBGM4(S1, S2, S3, S4, B)                       \
    {                                                  \
        ShowValues(B, "ssss", (S1), (S2), (S3), (S4)); \
    }
#define DBGM5(S1, S2, S3, S4, S5, B)                          \
    {                                                         \
        ShowValues(B, "sssss", (S1), (S2), (S3), (S4), (S5)); \
    }
#define DBGM6(S1, S2, S3, S4, S5, S6, B)                             \
    {                                                                \
        ShowValues(B, "ssssss", (S1), (S2), (S3), (S4), (S5), (S6)); \
    }

    // Double values only (integer will be converted and displayed correctly anyway)
#define DBGV(V1, B)                       \
    {                                     \
        ShowValues(B, "f", (double)(V1)); \
    }
#define DBGV2(V1, V2, B)                                 \
    {                                                    \
        ShowValues(B, "ff", (double)(V1), (double)(V2)); \
    }
#define DBGV3(V1, V2, V3, B)                                            \
    {                                                                   \
        ShowValues(B, "fff", (double)(V1), (double)(V2), (double)(V3)); \
    }
#define DBGV4(V1, V2, V3, V4, B)                                                       \
    {                                                                                  \
        ShowValues(B, "ffff", (double)(V1), (double)(V2), (double)(V3), (double)(V4)); \
    }
#define DBGV5(V1, V2, V3, V4, V5, B)                                                                  \
    {                                                                                                 \
        ShowValues(B, "fffff", (double)(V1), (double)(V2), (double)(V3), (double)(V4), (double)(V5)); \
    }
#define DBGV6(V1, V2, V3, V4, V5, V6, B)                                                                             \
    {                                                                                                                \
        ShowValues(B, "ffffff", (double)(V1), (double)(V2), (double)(V3), (double)(V4), (double)(V5), (double)(V6)); \
    }
#define DBGV7(V1, V2, V3, V4, V5, V6, V7, B)                                                                                        \
    {                                                                                                                               \
        ShowValues(B, "fffffff", (double)(V1), (double)(V2), (double)(V3), (double)(V4), (double)(V5), (double)(V6), (double)(V7)); \
    }
#define DBGV8(V1, V2, V3, V4, V5, V6, V7, V8, B)                                                                                                   \
    {                                                                                                                                              \
        ShowValues(B, "ffffffff", (double)(V1), (double)(V2), (double)(V3), (double)(V4), (double)(V5), (double)(V6), (double)(V7), (double)(V8)); \
    }
