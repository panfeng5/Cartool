...
#define PostfixStandardizationGrep "\\." \
                                   "(" PostfixStandardizationZScore ")"
#define InfixStandardizationFactorsGrep "\\." \
                                        "(" InfixStandardizationZScoreFactors ")"
...
#define InfixEpochGrep "(\\.|_)?" InfixEpoch "s? *[0-9]*" \
                       "(\\.|_)?"
...
#define InfixEpochConcatGrep "(\\.|_)?"                             \
                             "(Epoch|Concat|Concatenate)s? *[0-9]*" \
                             "(\\.|_)?"
