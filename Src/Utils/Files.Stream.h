...
namespace crtl
{
    ...
    inline ostream &StreamFormatFixed(ostream &os)
    {
    ...
    inline ostream &StreamFormatScientific(ostream &os)
    {
        os << scientific << right;
        return os;
    }
    ...
    inline ostream &StreamFormatGeneral(ostream &os)
    {
    ...
    inline ostream &StreamFormatFloat32(ostream &os)
    {
        os << " " << setprecision(7) << setw(WidthFloat32 - LeadingWidth) << StreamFormatRight;
        return os;
    }
    inline ostream &StreamFormatFloat64(ostream &os)
    {
        os << " " << setprecision(15) << setw(WidthFloat64 - LeadingWidth) << StreamFormatRight;
        return os;
    }
    inline ostream &StreamFormatFloat80(ostream &os)
    {
        os << " " << setprecision(19) << setw(WidthFloat80 - LeadingWidth) << StreamFormatRight;
        return os;
    }
    inline ostream &StreamFormatFloat128(ostream &os)
    {
        os << " " << setprecision(34) << setw(WidthFloat128 - LeadingWidth) << StreamFormatRight;
        return os;
    }
    inline ostream &StreamFormatInt8(ostream &os)
    {
        os << " " << setprecision(0) << setw(WidthInt8 - LeadingWidth) << StreamFormatRight;
        return os;
    }
    inline ostream &StreamFormatInt16(ostream &os)
    {
        os << " " << setprecision(0) << setw(WidthInt16 - LeadingWidth) << StreamFormatRight;
        return os;
    }
    inline ostream &StreamFormatInt32(ostream &os)
    {
        os << " " << setprecision(0) << setw(WidthInt32 - LeadingWidth) << StreamFormatRight;
        return os;
    }
    inline ostream &StreamFormatInt64(ostream &os)
    {
        os << " " << setprecision(0) << setw(WidthInt64 - LeadingWidth) << StreamFormatRight;
        return os;
    }
...
#undef ASSERT_TFileStream
    ...
    void TFileStream::Close()
    {
        if (IsOpen())
        {
            ...
            if (!closeok)
                ShowMessage("Close error", "TFileStream", ShowMessageWarning);
#endif
        }
...
#if defined(ASSERT_TFileStream)
        if (!OK)
            ShowMessage("Open error", "TFileStream", ShowMessageWarning);
#endif
...
#if defined(ASSERT_TFileStream)
        if (!OK)
            ShowMessage("Tell error", "TFileStream", ShowMessageWarning);
#endif
...
#if defined(ASSERT_TFileStream)
        if (!OK)
            ShowMessage("Seek error", "TFileStream", ShowMessageWarning);
#endif
...
#if defined(ASSERT_TFileStream)
        if (!OK)
            ShowMessage("Read error", "TFileStream", ShowMessageWarning);
#endif
...
#if defined(ASSERT_TFileStream)
        if (!OK)
            ShowMessage("Write error", "TFileStream", ShowMessageWarning);
#endif
