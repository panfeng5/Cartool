...
#define OmpParallelBegin  \
   __pragma(omp parallel) \
   {
#define OmpParallelEnd }

   // Explicit list of sections
#define OmpParallelSectionsBegin   \
   __pragma(omp parallel sections) \
   {
#define OmpParallelSectionsEnd }
#define OmpSectionBegin  \
...
#define OmpCriticalBegin(SECTIONNAME)  \
   __pragma(omp critical(SECTIONNAME)) \
   {
...
#define OmpCritical(INSTR) \
   __pragma(omp critical) { INSTR; }
