...
#define TIndexNull -1
    ...
    public:
        ...
        TIndex &operator=(const TIndex &op2)
        {
            Index = op2.Index;
            return *this;
        }
    ...
    using GLfloat = float;
    template <class GLfloat>
    class TGLCoordinates;
    template <class MriType>
    class TVolume;
    ...
    public:
        ...
        void Set(TypeD x, TypeD y, TypeD z)
        {
            X = x;
            Y = y;
            Z = z;
        ...
        void Set(const TPointT<double> &p)
        {
            X = p.X;
            Y = p.Y;
            Z = p.Z;
        }
        void Set(const TPointT<float> &p)
        {
            X = p.X;
            Y = p.Y;
            Z = p.Z;
        }
        void Set(const TPointT<int> &p)
        {
            X = p.X;
            Y = p.Y;
            Z = p.Z;
        ...
        void Set(const TGLCoordinates<GLfloat> &p)
        {
            X = p.X / NonNull(p.W);
            Y = p.Y / NonNull(p.W);
            Z = p.Z / NonNull(p.W);
        ...
        void Maxed(const TPointT<TypeD> &op)
        {
            return Maxed(X, op.X);
            Maxed(Y, op.Y);
            Maxed(Z, op.Z);
        ...
        void Mined(const TPointT<TypeD> &op)
        {
            return Mined(X, op.X);
            Mined(Y, op.Y);
            Mined(Z, op.Z);
        ...
        void Cumulate(const TPointT<TypeD> &p, bool invert)
        {
            if (invert)
                (*this) -= p;
            else
        ...
        TPointT<TypeD> &operator=(const TPointT<int> &op2)
        {
            X = op2.X;
            Y = op2.Y;
            Z = op2.Z;
        ...
        TPointT<TypeD> &operator=(const TPointT<float> &op2)
        {
            X = op2.X;
            Y = op2.Y;
            Z = op2.Z;
        ...
        TPointT<TypeD> &operator=(const TPointT<double> &op2)
        {
            X = op2.X;
            Y = op2.Y;
            Z = op2.Z;
        ...
        TPointT<TypeD> &operator=(const TPointT<long double> &op2)
        {
            X = op2.X;
            Y = op2.Y;
            Z = op2.Z;
        ...
        TypeD &operator[](int index) { return index == 0 ? X : index == 1 ? Y
                                                                          : Z; }
        const TypeD &operator[](int index) const { return index == 0 ? X : index == 1 ? Y
                                                                                      : Z; }
        ...
        TPointT<TypeD> &operator=(TypeD op2)
        {
            X = Y = Z = op2;
            return *this;
        }
        TPointT<TypeD> &operator=(const TypeD *op2)
        {
            X = op2[0];
            Y = op2[1];
            Z = op2[2];
        ...
        TPointT<TypeD> &operator=(const TGLCoordinates<GLfloat> &op2)
        {
            Set(op2);
            return *this;
        }

        TPointT<TypeD> operator+(int op2) const
        {
            TPointT<TypeD> temp(*this);
            temp.X += op2;
            temp.Y += op2;
            temp.Z += op2;
            return temp;
        }
        TPointT<TypeD> operator+(double op2) const
        {
            TPointT<TypeD> temp(*this);
            temp.X += op2;
            temp.Y += op2;
        ...
        TPointT<TypeD> operator+(long double op2) const
        {
            TPointT<TypeD> temp(*this);
            temp.X += op2;
            temp.Y += op2;
        ...
        TPointT<TypeD> operator+(const TPointT<TypeD> &op2) const
        {
            TPointT<TypeD> temp(*this);
            temp.X += op2.X;
            temp.Y += op2.Y;
        ...
        TPointT<TypeD> &operator+=(double op2)
        {
            X += op2;
            Y += op2;
            Z += op2;
        ...
        TPointT<TypeD> &operator+=(const TPointT<TypeD> &op2)
        {
            X += op2.X;
            Y += op2.Y;
            Z += op2.Z;
        ...
        TPointT<TypeD> &operator+=(const double *op2)
        {
            X += op2[0];
            Y += op2[1];
            Z += op2[2];
    ...
    public:
        ...
        TPointTI<TypeD> &operator=(const TPointTI<TypeD> &op2)
        {
            X = op2.X;
            Y = op2.Y;
            Z = op2.Z;
            Index = op2.Index; /*TPointT<TypeD>::operator= ( op2 ); TIndex::operator= ( op2 );*/
            return *this;
        }
    };
    ...
    void TPointT<TypeD>::GetOrthogonalVectors(TPointT<TypeD> &p1, TPointT<TypeD> &p2) const
    {
        ...
        if (d2n > d1n && d3n > d1n)
        {
            p1 = d2;
            p2 = d3;
        } // d1 is the worst -> keep the others
        else if (d1n > d2n && d3n > d2n)
        {
            p1 = d1;
            p2 = d3;
        } // d2 is the worst
