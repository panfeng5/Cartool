...
namespace crtl
{
      ...
      public:
            ...
            TFixedString(TFixedString &&str) noexcept
            {
                  Copy(str);
                  str.Clear();
            }
            ...
            TFixedString &Append(const TFixedString &str)
            {
                  StringAppend(String, str.String, MaxLength());
                  return *this;
            }
            TFixedString &Append(const char *str)
            {
                  StringAppend(String, str, MaxLength());
                  return *this;
            }
            TFixedString &Copy(const TFixedString &str)
            {
                  StringCopy(String, str.String, MaxLength());
                  return *this;
            }
            TFixedString &Copy(const char *str)
            {
                  StringCopy(String, str, MaxLength());
                  return *this;
            }

            TFixedString &operator=(const TFixedString &op2)
            {
                  if (&op2 != this)
                        Copy(op2);
                  return *this;
            }
            TFixedString &operator=(TFixedString &&op2) noexcept
            {
                  if (&op2 != this)
                  {
                        Copy(op2);
            ...
            friend std::ostream &operator<<(std::ostream &os, const TFixedString &str)
            {
                  os << str.String;
                  return os;
            }
