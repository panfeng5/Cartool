...
namespace crtl
{
    ...
    protected:
        ...
        inline void ClipLength()
        {
            if (Length > LimitLength)
                SetMinLength(Min, LimitLength, true);
        } // provide a default clipping
    };
    ...
    {
        return Min == op2.Min && Max == op2.Max;
    }
