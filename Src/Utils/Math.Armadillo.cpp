...
namespace crtl
{
    ...
    */
    ...
    void AEigenvalues33Smith(const AMatrix33 &M, AVector3 &D)
    {
        ...
        double p = (Square(B(0, 0)) + Square(B(1, 1)) + Square(B(2, 2)) + 2 * (Square(B(0, 1)) + Square(B(0, 2)) + Square(B(1, 2)))) / 6;
    ...
    void AEigenvalues33DDTT(const AMatrix33 &M, AVector3 &D)
    {
        ...
        double x1 = a * a + b * b + c * c - a * (b + c) - b * c + 3 * (d * d + e * e + f * f);

        double abc = 2 * a - b - c;
        double bac = 2 * b - a - c;
        double cab = 2 * c - a - b;

        double x2 = -abc * bac * cab + 9 * (cab * d * d + bac * f * f + abc * e * e) - 54 * d * e * f;
