...
namespace crtl
{
    ...
    OptimizeOff
        ...
        void
        CoregisterMris(const TVolumeDoc *SourceMri, RemapIntensityType fromremap,
                       ...
                       VerboseType verbosey)
    {
        ...
        */
        ...
        for (int i = 0; i < (int)buddypoints; i++)
        {
            ...
            if (isspfile)
                AddExtension(sourcecoregfile, FILEEXT_SPIRR);
            else
                AddExtension(sourcecoregfile, FILEEXT_XYZ);
