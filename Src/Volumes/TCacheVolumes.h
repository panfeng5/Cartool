...
namespace crtl
{
    ...
    bool TCacheVolume<TypeD>::IsACacheOf(TVolume<TypeD> *data, int dim1, int dim2, int dim3, TypeD chks)
    {
        ...
        return data == OrigData && dim1 == CacheData.GetDim1() && dim2 == CacheData.GetDim2() && dim3 == CacheData.GetDim3() && chks == OrigChecksum;
    }
    ...
    bool TCacheVolume<TypeD>::IsACacheOf(int dim1, int dim2, int dim3, double smoothing)
    {
        ...
        return dim1 == CacheData.GetDim1() && dim2 == CacheData.GetDim2() && dim3 == CacheData.GetDim3() && smoothing == Smoothing;
    }
    ...
    TVolume<TypeD> *TCacheVolumes<TypeD>::GetCache(int dim1, int dim2, int dim3, bool &reload)
    {
        ...
        { // no more free slot -> find the oldest used Cache, and pitylessly overwrite it
    ...
    TVolume<TypeD> *TCacheVolumes<TypeD>::GetCache(int dim1, int dim2, int dim3, double smoothing, bool &reload)
    {
        ...
        { // no more free slot -> find the further smoothing Cache, and pitylessly overwrite it
