...
namespace crtl
{
        ...
        bool Volume::SkullStripping(FctParams &params, bool showprogress)
        {
                ...
                if (version == SkullStripping1A)
                        skstrok = SkullStripping_1A(params, showprogress);
                else if (version == SkullStripping1B)
                        skstrok = SkullStripping_1B(params, showprogress);
                else if (version == SkullStripping2)
                        skstrok = SkullStripping_2(params, showprogress);
                else if (version == SkullStripping3)
                        skstrok = SkullStripping_3(params, showprogress);
                else
                        skstrok = SkullStripping_1B(params, showprogress);
