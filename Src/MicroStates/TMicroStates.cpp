...
namespace crtl
{
    ...
    */
    ...
    void TMicroStates::ComputeGevPerCluster(int nclusters,
                                            const TMaps &maps,
                                            const TLabeling &labels,
                                            TVector<double> &gevpercluster) const
    {
                                                 ...
                                                 bool precise)
    {
        ...
        for (int nc = 0; nc < nummaps; nc++)
        {
            ...
            if (precise)
            {
                ...
                alldisp(DispersionMean, nc) = (alldisp(DispersionCentroidSD, nc) + alldisp(DispersionCentroidMAD, nc) + alldisp(DispersionPooledMAD, nc)) / 3;
                                    ...
                                    const char *filename) const
    {
        ...
        for (long tf = 0; tf < MaxNumTF; tf++)
        {
            ...
            for (int fi = 0; fi < NumFiles; fi++)
            {
                ...
                { // pad trailing time points with 0's
