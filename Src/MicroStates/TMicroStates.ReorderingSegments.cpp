...
namespace crtl
{
    ...
    void TMicroStates::PostProcOrdering(TArray2<int> &ordering) const
    {
                                                ...
                                                TArray2<int> &ordering) const
    {
        ...
        if (nclusters == 0 || numtemplates == 0 || maps.GetDimension() != templatesmaps.GetDimension())
