    ...
    void TEegBioLogicDoc::ReadNativeMarkers()
    {
        ...
        if (ifsmrk.good())
        {
            ...
            do
            {
                ...
                if (mrk.marker_deleted || mrk.marker_point_num < Sequences[CurrSequence].StartingPacketNumber || mrk.marker_point_num > Sequences[CurrSequence].EndingPacketNumber)
                {
        ...
        if (GetDocPath())
        {
            ...
            do
            {
                ...
                case MARKER_DATA_START:
                    ...
                    Sequences[CurrSequence].NumTimeFrames = Sequences[CurrSequence].EndingPacketNumber - Sequences[CurrSequence].StartingPacketNumber + 1;
                    // time in seconds since 1-1-1970
